...
async function main() {
  ...
  // Run npm lint command to fix all the linting error and give space after imports
  consola.start('Run npm lint command to fix all the linting error and give space after imports')

  await exec('npm run lint:fix')

  consola.success('Linted all the files successfully!\n')

  // Run npm format command to format all the files using prettier
  consola.start('Run npm format command to format all the files using prettier')
